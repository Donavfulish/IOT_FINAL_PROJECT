...
const StatItem: React.FC<StatItemProps> = ({ icon, label, value, percentage, color }) => {
    return (
        <div className="mb-8">
...
const QuickStatus: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-950 p-6 flex items-center justify-center">
            <div className="w-full max-w-2xl bg-gray-900 rounded-3xl p-8 shadow-2xl">
                <h1 className="text-3xl font-bold text-white mb-10">Quick Stats</h1>
