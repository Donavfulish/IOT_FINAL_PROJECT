                    ...
                    <div className="flex items-center justify-between gap-4 flex-wrap">
                        <div>
                            <div className="flex items-center gap-3">
                                ...
                                <div className={`px-3 py-1 rounded-full text-sm font-semibold ${getStatusColor(binData.status)}`}>
                                    {binData.status.toUpperCase()}
                                </div>
                            </div>
                            <p className="text-xs text-muted-foreground mt-1">Last Updated: {binData.lastUpdated}</p>
                        </div>
                    </div>
                </div>
            </header>
                            ...
                            <CardContent>
                                <div className="space-y-3 max-h-64 overflow-y-auto">
                                    <div className="flex gap-3 pb-3 border-b border-border/30">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium text-foreground">Status: Operational</p>
                                            <p className="text-xs text-muted-foreground">2025-11-03 09:12:00</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3 pb-3 border-b border-border/30">
                                        <div className="w-2 h-2 rounded-full bg-yellow-500 mt-2 flex-shrink-0"></div>
                                        <div>
                                            <p className="text-sm font-medium text-foreground">Fill Level Warning: 78%</p>
                                            <p className="text-xs text-muted-foreground">2025-11-03 08:30:00</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3 pb-3">
                                        <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                                        <div>
                                            <p className="text-sm font-medium text-foreground">Device Emptied</p>
                                            <p className="text-xs text-muted-foreground">2025-10-25 14:30:00</p>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
                            ...
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <div className="w-full bg-secondary rounded-full h-2">
                                        <div className="h-full rounded-full bg-green-500" style={{ width: `${binData.battery}%` }}></div>
                                    </div>
                                    <p className="text-sm font-semibold text-foreground mt-1">{binData.battery}%</p>
                                </div>
                                ...
                                <div className="pt-4 border-t border-border/30">
                                    ...
                                    <p className="text-sm font-semibold text-foreground">{binData.temperature}°C</p>
                                </div>
                                ...
                                <div className="pt-4 border-t border-border/30">
                                    ...
                                    <div className="w-full bg-secondary rounded-full h-2">
                                        <div className="h-full rounded-full bg-primary" style={{ width: `${binData.fillLevel}%` }}></div>
                                    </div>
                                    <p className="text-sm font-semibold text-foreground mt-1">{binData.fillLevel}%</p>
                                </div>
                            </CardContent>
                        </Card>
                                    ...
                                    {lcdMode === "fillLevel" ? (
                                        <div className="p-3 bg-secondary rounded border border-border/50 text-sm text-foreground h-16 flex items-center justify-center text-center">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-primary">{binData.fillLevel}%</p>
                                            </div>
                                        </div>
                                    ) : (
                                        <>
                            ...
                            <Card className="border-border/50 bg-card/50">
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-muted-foreground">LED Status</span>
                                        <button
                                            onClick={() => setLedEnabled(!ledEnabled)}
                                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${ledEnabled ? "bg-primary" : "bg-secondary"
                                                }`}
                                        >
                                            <span
                                                className={`inline-block h-4 w-4 transform rounded-full bg-background transition-transform ${ledEnabled ? "translate-x-6" : "translate-x-1"
                                                    }`}
                                            />
                                        </button>
                                    </div>
                                    ...
                                    <div className="pt-3 border-t border-border/30 space-y-3">
                                        <div>
                                            <label className="text-sm text-muted-foreground mb-2 block">Schedule Mode</label>
                                            <select
                                                value={ledSchedule}
                                        ...
                                        {ledSchedule === "auto" && (
                                            <div className="space-y-2">
                                                <div>
                                                    <label className="text-xs text-muted-foreground block mb-1">Turn On Time</label>
                                                    <input
                                                        type="time"
                                                        value={ledStartTime}
                                                ...
                                                <div>
                                                    <label className="text-xs text-muted-foreground block mb-1">Turn Off Time</label>
                                                    <input
                                                        type="time"
                                                        value={ledEndTime}
                            ...
                            <Card className="border-primary/30 bg-primary/10">
                                <CardContent className="pt-6">
                                    <p className="text-sm text-muted-foreground mb-3">
                                        Sign in to unlock advanced controls like editing messages and managing LED lights.
                                    </p>
                                    <Link href="/">
